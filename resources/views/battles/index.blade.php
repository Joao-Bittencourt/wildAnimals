                ...
                <table class="table table-sm table-hover table-centered table-nowrap mb-0">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="text-center">{{ __('messages.attack') }}</th>
                            <th class="text-center">{{ __('messages.defense') }}</th>
                            <th class="text-center">{{ __('messages.winner') }}</th>
                    ...
                    <tbody id="table-body">
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <img src="{{ asset($battle->bPlayerAnimal->animal->image_path) }}" class="rounded-circle" style="width: 100px;" alt="quixote">
                            </td>
                            <td>{{ $battle->bPlayerAnimal->name }}</td>
                            <td>{{ $battle->bPlayerAnimal->hp }}</td>
                            <td>{{ $battle->bPlayerAnimal->attack }}</td>
                            <td>{{ $battle->bPlayerAnimal->defense }}</td>
                            <td>{{ $battle->WinnerPlayerAnimal?->name }}</td>
                            <td>
                                <a href="{{ route('battles.show', ['id' => $battle->id]) }}" class="btn btn-sm btn-primary" title="{{ __('messages.show') }}">
